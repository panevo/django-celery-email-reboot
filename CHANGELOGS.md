...
- [#11](https://github.com/panevo/django-celery-email-reboot/pull/11) Add support for custom email message deserialization class via `CELERY_EMAIL_MESSAGE_CLASS` setting
